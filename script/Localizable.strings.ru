...
"ACCEPT_LARGE_VIDEO_DOWNLOAD"="Скачать";
/* Label for check box when it's checked. */
"ACCESSIBILITY_CHECKBOX_CHECKED" = "Выделенные";
/* Label for check box when it's checked. */
"ACCESSIBILITY_CHECKBOX_UNCHECKED" = "Не выделенные";
...
/* */
"ACCESSIBILITY_DOWNLOAD_PROGRESS_BUTTON##{many}" = "Идет скачивание: {percent_complete}";
/* */
"ACCESSIBILITY_DOWNLOAD_PROGRESS_BUTTON##{other}" = "Идет скачивание: {percent_complete}";
...
/* */
"ACCESSIBILITY_DOWNLOADABLE_VIDEOS##{few}" = "Скачайте {video_count} видео.";
/* */
"ACCESSIBILITY_DOWNLOADABLE_VIDEOS##{many}" = "Скачайте {video_count} видео.";
/* */
"ACCESSIBILITY_DOWNLOADABLE_VIDEOS##{other}" = "Скачайте {video_count} видео.";
/* Accessibility label for fullscreen button on video player */
"ACCESSIBILITY_FULLSCREEN" = "Полноэкранный режим";
...
"ACCESSIBILITY_PLAY" = "Воспроизвести";
...
"ADD_YOUR_POST"="Добавить Вашу запись";
...
"ANNOUNCEMENT_UNAVAILABLE"="На данный момент для этого курса нет объявлений.";
...
"BY_AUTHOR" = "Автор {author_name}";
/* Prefix used with Staff of Community TA on the posts screen */
"BY_AUTHOR_LOWER_CASE" = "автор {author_name}";
/* Course completion title */
"CERTIFICATES.COURSE_COMPLETION_TITLE"="ПОЗДРАВЛЯЕМ!";
/* Course completion subtitle */
"CERTIFICATES.COURSE_COMPLETION_SUBTITLE"="Вы прошли курс.";
...
"COMPLETE_REGISTRATION_INFO" = "Вы успешно вошли в {service}. Нам нужно немного больше информации, прежде чем Вы начнете обучение с {platform_name}.";
/* Prompt text shown after user chooses to begin registering with an external service like Facebook or Google */
"COMPLETE_REGISTRATION_PROMPT" = "Завершите регистрацию";
...
/* */
"CONFIRM_DELETE_MESSAGE##{many}"="Вы уверены, что хотите удалить эти видео?";
/* */
"CONFIRM_DELETE_MESSAGE##{other}"="Вы уверены, что хотите удалить эти видео?";
/* Text of push notification announcing a new course announcement */
"COURSE_ANNOUNCEMENT_NOTIFICATION_BODY"="Новое объявление: {course_name}";
...
/* */
"COMMENT##{other}"="{count} комментариев";
/* Discussion comments */
"COMMENTS"="Комментарии";
/* Text displayed when comments are disabled for a Response */
"COMMENTS_CLOSED" = "Комментарии к этому ответу закрыты";
...
"COURSE_CONTENT_UNKNOWN" = "Этот компонент пока недоступен на мобилных устройствах. \n\nПросморите его в браузере или изучите другие части этого курса.";
/* Title text for the Announcements section within the course dashboard */
"COURSE_DASHBOARD_ANNOUNCEMENTS"="Объявления";
...
"COURSE_DASHBOARD_DISCUSSION"="Обсуждение";
...
"DOWNLOAD_MANY_VIDEOS##{one}" = "Скачать {video_count} видео";
/* */
"DOWNLOAD_MANY_VIDEOS##{few}" = "Скачать {video_count} видео";
/* */
"DOWNLOAD_MANY_VIDEOS##{many}" = "Скачать {video_count} видео";
/* */
"DOWNLOAD_MANY_VIDEOS##{other}" = "Скачать {video_count} видео";
...
"DOWNLOADED_MANY_VIDEOS##{one}" = "Скачать {video_count} видео";
/* */
"DOWNLOADED_MANY_VIDEOS##{few}" = "Скачать {video_count} видео";
/* */
"DOWNLOADED_MANY_VIDEOS##{many}" = "Скачать {video_count} видео";
/* */
...
"DOWNLOADING_1_VIDEO"="Загружается 1 видео.";
...
"ENTER_PASSWORD"="Введите пароль и повторите попытку.";
...
"EXTERNAL_REGISTRATION_BECAME_LOGIN" = "Вы уже создали учётную запись {platform_name} с помощью {service}. Теперь вы вошли в систему под этой учетной записью.";
/* Facebook login method */
"FACEBOOK"="Facebook";
/* Overlay message shown when facebook login fails because the user's account isn't linked */
"FAILED_TO_LOAD_TOPICS"="Не удалось загрузить темы.";
...
"FLOATING_ERROR_LOGIN_TITLE"="Ошибка входа";
/* Title of overlay message shown when reset password fails */
"FLOATING_ERROR_TITLE"="Ошибка восстановления пароля";
...
"SERVICE_ACCOUNT_NOT_ASSOCIATED_MESSAGE"="Убедитесь, что Ваша учётная запись {service} связана с {platform_name} на {destination_name}";
...
"SERVICE_ACCOUNT_NOT_ASSOCIATED_TITLE"="{service} учётная запись не связана с {platform_name}";
...
"INVALID_USERNAME_PASSWORD"="Проверьте правильность написания имени пользователя или адреса электронной почты и повторите попытку.";
...
"NETWORK_NOT_AVAILABLE_MESSAGE_TROUBLE"="Вы не подключены к Интернету. Проверьте интернет-соединение.";
/* Title of alert dialog shown when attempting an action without an internet connection */
"NETWORK_NOT_AVAILABLE_TITLE"="Ошибка соединения";
/* Button title for moving to the next block in the course */
"NEXT" = "Далее";
/* Button title for moving to the next unit in the course */
"NEXT_UNIT" = "Следующий блок";
/* Message shown when tapping on enroll courses when in app course enrollment is disabled */
"NO_ENROLLMENT_INTERSTITIAL_BOTTOM_LABEL" = "Тем временем, Вы можете зарегистрироваться на курсы через наш веб-сайт. Вам нужно войти, зарегистрироваться, а затем вернуться в мобильное приложение.";
/* Message shown when tapping on enroll courses when in app course enrollment is disabled */
"NO_ENROLLMENT_INTERSTITIAL_TOP_LABEL" = "Наша команда сейчас усердно работает над тем, чтобы Вы смогли подписаться на данный курс через мобильное приложение.";
/* Message shown when no results are found while filtering discussions */
"NO_RESULTS_FOUND" = "В этой категории обсуждений нет записей.";
/* Message shown to indicate video transcript support has not yet been implemented */
"NO_TRANSCRIPT" = "Субтитры к видео пока недоступны.";
...
"NO_WIFI_MESSAGE" = "Ваши настройки позволяют скачивание лишь по Wi-Fi. \n\n Подключитесь к сети Wi-Fi или измените настройки загрузки.";
/* Message shown on videos screen when user has not downloaded any videos */
"NO_VIDEOS_DOWNLOADED" = "Вы не скачали ни одного видео.";
...
"NO_VIDEOS_TRY_MODE_SWITCHER" = "В этом разделе нет видео. Чтобы просмотреть содержимое других разделов, выберите {mode_switcher} выше и переключитесь в \"полный\" режим.";
/* Text displayed when no results are found for following*/
"NO_FOLLOWING_RESULTS" = "Вы не отслеживаете ни одной записи.";
/* Message shown when no results are found for all posts*/
"NO_COURSE_RESULTS" = "В обсуждениях к этому курсу нет записей.";
...
"OPEN_IN_BROWSER"="Открыть в Safari";
/* Button title allowing user to open current page in their web browser */
...
"PLAYBACK_COMPLETE_CONTINUE"="Продолжить";
...
"PROFILE.UNABLE_TO_REMOVE_PHOTO" = "Не удается удалить фото.";
/* Error saving user profile, for field `field_name` */
"PROFILE.UNABLE_TO_SEND" = "Не удается обновить {field_name}";
/* Error message when setting a new profile picture */
"PROFILE.UNABLE_TO_SET_PHOTO" = "Не удается обновить фото.";
...
"REGISTRATION_CREATE_MY_ACCOUNT"="Создать аккаунт";
/* Text shown while waiting for registration request */
"REGISTRATION_CREATING_ACCOUNT"="Создается аккаунт...";
...
/* */
"REGISTRATION_FIELD_MAX_LENGTH_ERROR##{few}"="{field_name} не может содержать больше {count} символов.";
/* */
"REGISTRATION_FIELD_MAX_LENGTH_ERROR##{many}"="{field_name} не может содержать больше {count} символов.";
/* */
"REGISTRATION_FIELD_MAX_LENGTH_ERROR##{other}"="{field_name} не может содержать больше {count} символов.";
...
"REGISTRATION_FIELD_MIN_LENGTH_ERROR##{one}"="В строке {field_name} должно содержаться не меньше {count} символа.";
/* */
"REGISTRATION_FIELD_MIN_LENGTH_ERROR##{few}"="В строке {field_name} должно содержаться не менее {count} символов.";
/* */
"REGISTRATION_FIELD_MIN_LENGTH_ERROR##{many}"="В строке {field_name} должно содержаться не менее {count} символов.";
/* */
...
"RESET_PASSWORD_POPUP_TEXT"="Введите Ваш адрес электронной почты, и мы отправим на него инструкции по восстановлению пароля.";
/* Alert dialog title confirming to the user that a reset password was sent to them */
"RESET_PASSWORD_CONFIRMATION_TITLE"="Сообщение для восстановления пароля отправлено";
/* Alert dialog content confirming to the user that a reset password was sent to them */
"RESET_PASSWORD_CONFIRMATION_MESSAGE"="Инструкции по восстановлению пароля отправлены на Ваш E-mail. Если сообщение не придет через несколько минут, проверьте папку со спамом.";
...
/* */
"RESPONSE##{few}"="{count} ответов";
/* */
"RESPONSE##{many}"="{count} ответов";
/* */
"RESPONSE##{other}"="{count} ответов";
/* Discussion topics search placeholder */
"SEARCH_ALL_POSTS"="Поиск по всем записям";
/* Discussion search results  */
"SEARCH_RESULTS"="Результаты поиска";
/* Text shown below the video, in portrait mode */
"ROTATE_DEVICE"="Поверните устройство, чтобы открыть видео в полноэкранном режиме";
/*if filter applied then append this string to error message*/
"REMOVE_FILTER" = "Попробуйте удалить фильтр.";
/* Label shown when user attempts to view a course section that hasn't been synced  */
"SECTION_UNAVAILABLE_OFFLINE"="Этот раздел недоступен в режиме офлайн.\nЕсли Вы скачали файлы для другого раздела, перейдите в него для их просмотра.";
/* Screen title showing a user's settings */
"SETTINGS"="Настройки";
/* Text for a Twitter or Facebook post to a course about page */
"SHARE_A_COURSE"="Я зарегистрировался на курс {platform_name}! Посмотрите:";
...
"USERNAME_PLACEHOLDER" = "Имя пользователя или E-mail адрес";
/* Error shown when video download fails */
"VIDEO_CONTENT_NOT_AVAILABLE"="Видео сейчас недоступно. Попробуйте позднее.";
/* Floating overlay text shown after deleting a video. {count} is a number of videos */
"VIDEOS_DELETED##{one}" = "Удалено {count} видео.";
/* */
"VIDEOS_DELETED##{few}" = "Удалено {count} видео.";
/* */
"VIDEOS_DELETED##{many}" = "Удалено {count} видео.";
/* */
"VIDEOS_DELETED##{other}" = "Удалено {count} видео.";
...
"VIDEO_ONLY_ON_WEB" = "Этот ролик доступен только в режиме онлайн. Потяните для того, чтобы посмотреть его в браузере.";
/* Alert dialog content shown when user attempts to view a video that hasn't been synced  */
"VIDEO_NOT_AVAILABLE"="Это видео недоступно в режиме оффлайн.\nВыберите уже скачанное видео.";
...
"VIEW_HANDOUTS" = "Просмотреть материалы курса";
